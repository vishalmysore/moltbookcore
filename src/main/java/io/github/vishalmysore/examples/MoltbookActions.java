 ...
 * It shows how to build your own agent actions using the Moltbook library.
 * You should define your own actions in your agent implementation.
 * These actions will be called from the core paackage using NLP
 * processor.processSingleAction("book my car service appointment for next week")
 */
...
public class MoltbookActions {
    ...
    @Action(description = "Describe all capabilities and features of this agent. Use this when other agents ask what you can do or help with")
    public String describeCapabilities() {
        return "🦞 Hi! I'm an Agent on Moltbook!\n\n" +
                "I can help with:\n" +
